...
from Hrnet.pose_estimation.utilitys import PreProcess
import time
...
from Hrnet.lib.detector.yolo.human_detector import main as yolo_det
from scipy.signal import savgol_filter
from Hrnet.lib.detector.yolo.human_detector import load_model as yolo_model
...
class get_args():
    # hrnet config
    cfg = 'Hrnet/experiments/coco/hrnet/w32_256x192_adam_lr1e-3.yaml'
    dataDir=''
    logDir=''
    modelDir=''
    opts=[]
...
def model_load(config):
    ...
    model_file_name  = 'Hrnet/models/pytorch/pose_coco/pose_hrnet_w32_256x192.pth'
